...
#             # rename and send as sku qunatity and price 
...
#                         create_missing_salesorder_component(
#                             {**result_df, **zakya_connection}
#                         )
...
from frontend_components.pernia.index import main

def pernia_component():
    main()
