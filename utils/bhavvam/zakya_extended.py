...
def list_invoice_template(base_url, access_token, organization_id):
    """Updates the PDF template associated with an invoice."""
    print(f"Getting templates for you...")
    return make_request("GET",base_url, f"invoices/templates", access_token, organization_id)
...
def update_payment(base_url,  access_token, organization_id, payment_id, update_data):
    ...
    return make_request("PUT",base_url, f"customerpayments/{payment_id}", access_token, organization_id, update_data)
